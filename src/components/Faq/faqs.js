export const faqs = [
    ...
    {
        id: 2,
        title: '¿QUÉ ES ADEE Y A QUE SE DEDICA?',
        description: 'Son las iniciales de la Asociación de Emprendedores, un colectivo creado pensando en un “ente” que represente al emprendimiento colombiano, sin ánimo de lucro que busca el bien común de los empresarios y sus iniciativas.'
    },
    {
        id: 3,
        title: '¿CÓMO HACER PARTE DE LA ADEE?',
        description: 'El requisito principal es ser emprendedor y querer formar parte de este gran movimiento. Seguir a @asociaciondeemprendedores_ y enviar un mensaje directo solicitando el formulario de inscripción, el equipo de AdeE te dará toda la información que necesites y solucionará todas tus dudas.'
    },
    {
        id: 4,
