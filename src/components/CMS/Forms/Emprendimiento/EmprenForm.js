...
export const EmprenForm = ({ data }) => {
  ...
  useEffect(() => {
    const userId = localStorage.getItem("userId");
    getPerfil(userId).then((data) => setPerfil(data.data.perfil));
  }, []);

  const onErrors = (errors) => {
    console.log("aa", errors);
    if (Object.keys(errors).length > 0) setGlobalError(true);
  };
  ...
  return (
    <>
      <Form
        ref={formRef}
        validationSchema={emprenSchema}
        onErrors={onErrors}
        onSubmit={submitContenido}
        render={({ control }) => {
          return (
            <>
              {Object.keys(perfil).length !== 0 ? (
                <div className="recopilacion_form">
                  ...
                  <div className="indication">
                    Selecciona la categoría a la cual pertenece tu
                    emprendimiento
                  </div>
                  <div className="form-field">
                    <Select
                      ...
                      options={categorias}
                      defaultValue={realCategory()}
                    />
                  </div>

                  <div className="form-field">
                    <div className="indication">
                      Escribe una descripcion de la marca que contenga máximo
                      100 palabras
                    </div>
                    <Input
                      control={control}
                  ...
                  <div className="form-field mb-2">
                    <div className="indication">
                      ...
                      Por favor escribe el URL completo copiándolo y pegándolo
                      desde tu navegador arrancando por https://… <br />
                    ...
                    <Input
                      control={control}
                      name="urlWeb"
                      placeholder="LINK DE WEB"
                      maxLength="200"
                      defaultValue={perfil.urlWeb}
                    />
                  </div>
                  <div className="form-field mb-2">
                    <Input
                      control={control}
                      name="urlInsta"
                      placeholder="LINK DE INSTA"
                      maxLength="200"
                      defaultValue={perfil.urlInsta}
                    />
                  </div>
                  ...
                  <div className="recopilacion_section">
                    ...
                    <div className="indication">
                      Se requieren de 3 a 5 imágenes características de la marca
                      o sus productos que aparecerán en su perfil de la pagina
                      web
                    </div>
                    <div className="indication">
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.galeriaImg1}
                          required={true}
                        />
                      </div>
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.galeriaImg2}
                          required={true}
                        />
                      </div>
                      <div className="indication">.jpg</div>
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.galeriaImg3}
                          required={true}
                        />
                      </div>
                      <div className="indication">.jpg</div>
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.galeriaImg4}
                          opcional={true}
                        />
                      </div>
                      <div className="indication">.jpg</div>
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.galeriaImg5}
                          opcional={true}
                        />
                      </div>
                      <div className="indication">.jpg</div>
                  ...
                  <div className="recopilacion_section mt-3">
                    ...
                    <div className="indication">
                      Se requiere 1 imagen características de la marca (sin
                      texto), que aparecerá en el menú de la pagina web.
                    </div>
                    <div className="indication">
                    ...
                    <div className="file-field">
                      <div className="">
                        <FileUpload
                          ...
                          onSelect={() => {}}
                          setErrorFile={() => {}}
                          defaultValue={perfil.imagenMenu}
                          required={true}
                        />
                      </div>
                      <div className="indication">.jpg</div>
                  ...
                  <div className="recopilacion_submit">
                    {!loading ? (
                      ...
                      <div className="loading-msg">
                        <span>
                          Estamos guardando tu información: Por favor no cierres
                          esta pestaña.{" "}
                        </span>
                      </div>
                    )}
